...
Copy-Item (Join-Path $root "js\supabase-api.js"), (Join-Path $root "js\script.js"), (Join-Path $root "js\admin.js"), (Join-Path $root "js\public-config.js") -Destination $jsDocs -Force
